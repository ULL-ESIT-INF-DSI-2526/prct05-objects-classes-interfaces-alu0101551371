...
describe("Recetario", () => {
    ...
    expect(receta1.pasos).toEqual([
      {
        nombre: "Paso 1",
        duracion: 10,
        etiquetasClasificacion: ["etiqueta1"],
        numVecesCompletado: 5,
        pasoOpcional: undefined,
      },
      {
        nombre: "Paso 2",
        duracion: 20,
        etiquetasClasificacion: ["etiqueta2"],
        numVecesCompletado: 3,
        pasoOpcional: true,
      },
    ]);
  });
  ...
  test("filtradoPasos", () => {
    ...
    expect(receta2.filtradoPasos({ duracion: 25 })).toEqual([
      {
        nombre: "Paso B",
        duracion: 25,
        etiquetasClasificacion: ["etiquetaB"],
        numVecesCompletado: 2,
        pasoOpcional: undefined,
      },
    ]);
    expect(
      receta3.filtradoPasos({ etiquetasClasificacion: "etiquetaX" }),
    ).toEqual([
      {
        nombre: "Paso X",
        duracion: 5,
        etiquetasClasificacion: ["etiquetaX"],
        numVecesCompletado: 6,
        pasoOpcional: undefined,
      },
    ]);
    ...
    expect(
      receta3.filtradoPasos({ etiquetasClasificacion: "etiquetaZ" }),
    ).toEqual([]);
        ...
        pasos: [
          {
            nombre: "Paso A",
            duracion: 15,
            etiquetasClasificacion: ["etiquetaA"],
            numVecesCompletado: 4,
            pasoOpcional: undefined,
          },
          {
            nombre: "Paso B",
        ...
        recetario: [
          {
            ...
            pasos: [
              ...
              },
              {
                nombre: "Paso Y",
                duracion: 30,
                etiquetasClasificacion: ["etiquetaY"],
                numVecesCompletado: 1,
                pasoOpcional: undefined,
              },
            ],
          },
