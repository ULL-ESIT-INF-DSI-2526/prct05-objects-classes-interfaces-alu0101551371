...
export class Sistema {
	 ...
	 */
	public tablaChefs(): {chef: string, receta: string, anyo: number, pasos_totales: number, tiempo_min: number, tiempo_max: number, paso: string, duracion: number, etiquetas: string}[] {
